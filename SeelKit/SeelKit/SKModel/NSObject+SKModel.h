 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `SKModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface SKAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation SKAuthor
     @end
 
     @interface SKBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) SKAuthor *author;
     @end
     @implementation SKBook
     @end
    
     int main() {
         // create model from json
         SKBook *book = [SKBook SK_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book SK_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface SKShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation SKShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self SK_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self SK_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self SK_modelCopy]; }
     - (NSUInteger)hash { return [self SK_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self SK_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (SKModel)
 ...
 */
+ (nullable instancetype)SK_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "SKSK-MM-dd'T'HH:mm:ssZ", "SKSK-MM-dd HH:mm:ss" or "SKSK-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)SK_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)SK_modelToJSONObject;
 ...
 */
- (nullable NSData *)SK_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)SK_modelToJSONString;
 ...
 */
+ (nullable NSArray *)SK_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (SKModel)
 ...
 */
+ (nullable NSDictionary *)SK_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<SKModel>' to your class header.
 */
@protocol SKModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class SKShadow, SKBorder, SKAttachment;
        ...
        @implementation SKAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [SKShadow class],
                     @"borders" : SKBorder.class,
                     @"attachments" : @"SKAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @class SKCircle, SKRectangle, SKLine;
 
        @implementation SKShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [SKCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [SKRectangle class];
