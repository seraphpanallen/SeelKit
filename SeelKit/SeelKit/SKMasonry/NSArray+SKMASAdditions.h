...
typedef NS_ENUM(NSUInteger, SKMASAxisType) {
    SKMASAxisTypeHorizontal,
    SKMASAxisTypeVertical
};

@interface NSArray (SKMASAdditions)

/**
 *  Creates a SKMASConstraintMaker with each view in the callee.
